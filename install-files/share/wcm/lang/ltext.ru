...
#ncwin.cpp:60
id "=  panels"
txt "сделать неактивную панель равной активной"
...
txt "Не удается скопировать файл, цель не найдена"
...
txt "Не удается переместить файл, неверная целевая папка\n"
...
txt "Цель не является каталогом"
...
#wcm-config.cpp:1167
id "Help bold text"
txt "Помощь, толстый шрифт"

#wcm-config.cpp:1168
id "Help header text"
txt "Помощь, заголовок"
...
#wcm-config.cpp:1383
id "Interface localisation (save config and restart)"
txt "Локализация (требует сохранения и перезапуска)"
...
txt "%s байт в %i файле"

#panel.cpp:1381
id "%s bytes in %i files"
txt "%s байт в %i файлах"
